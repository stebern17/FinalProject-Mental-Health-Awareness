  ...
  return (
    ...
    >
      ...
      <motion.div className="text-center mt-5" variants={textVariants}>
        ...
        <p className="mt-2 text-[#6A9C89]">Silahkan tunggu konfirmasi dari admin.</p>
        <Link to="/user" className="mt-4 text-[#16423C] hover:underline cursor-pointer">
